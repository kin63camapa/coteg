#ifndef SIMPLEREACTIONS_H
#define SIMPLEREACTIONS_H

#include <QObject>
#include "../../libs/basicstruct/basicstruct.h"
#include "plugin.h"

class SIMPLEREACTIONS : public QObject, public Plugin{
    Q_OBJECT
    Q_INTERFACES( Plugin )
#if QT_VERSION > 0x050000
    Q_PLUGIN_METADATA(IID "ru.sysadm63.coteg.tgbotplugin/1.0" FILE "simplereactions.json")
#endif
public:
    SIMPLEREACTIONS();
